...
//  Shared variables
//-----------------------------------------------------------------------------
var InDegree = [];                  // number of incoming links to each node
var StartPos = [];                  // start of a node's outlinks in AdjList
var AdjList = [];                   // list of outlink indexes for each node
var Stack = [];                     // array of nodes "reached" during sorting
var  First;                     // position of first node in stack
var  Last;                      // position of last node added to stack

var Examined;                 // true if node included in spanning tree
var InTree;                   // state of each link in spanning tree:
                                       // 0 = unexamined,
                                       // 1 = in spanning tree,
                                       // 2 = chord of spanning tree
var LoopLinks = [];                // list of links which forms a loop
var LoopLinksLast;            // number of links in a loop
...
//=============================================================================
// int sortedLinks[]
function toposort_sortLinks(sortedLinks)
//
//  Input:   none
...
//=============================================================================
// int listType
function createAdjList(listType)
//
...
//=============================================================================
// int startNode
function  findSpanningTree(startNode)
//
