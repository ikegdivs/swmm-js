...
Module.arguments = ['Example1.inp', './swmm.js/data/Example1.rpt', './swmm.js/data/Example1.out'];
...
//Module.arguments = ['./data/Example1.inp', './data/Example1.rpt', './data/Example1.out'];
//Module['arguments'].push('./data/Example1.inp'); 
//Module['arguments'].push('./data/Example1.rpt'); 
//Module['arguments'].push('./data/Example1.out');
